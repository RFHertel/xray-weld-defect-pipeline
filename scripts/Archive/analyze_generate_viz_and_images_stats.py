...
viz_dir = "viz"
regen_viz = True   # <<== SET TO False to skip re-generating images
...
# SAVE OUTPUTS
# -------------------------
with open("image_stats.json", "w", encoding="utf-8") as f:
    json.dump(image_stats, f, indent=2, ensure_ascii=False)

with open("dataset_totals.json", "w", encoding="utf-8") as f:
    json.dump(dataset_totals, f, indent=2, ensure_ascii=False)

with open("master_index.json", "w", encoding="utf-8") as f:
    json.dump(master_index, f, indent=2, ensure_ascii=False)

with open("log_unknowns.json", "w", encoding="utf-8") as f:
    json.dump(unknown_labels, f, indent=2, ensure_ascii=False)
